 ...
 * Direct Loans" set, plus the FSA Q&A April 2026 examples.
 *
...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    summary:
      "Sub $2,000 · Fall 9 / Spring 12 / Summer 15 (FT 12/12/12) · 36 AY FT.",
    expected:
  ...
  // -------- Disbursement-mode (recalc) --------
  {
    ...
    summary:
      "Sub $3,500 · Fall 9 paid as planned ($875 share × 75% pct = ~$1,313). In Spring student drops to 6.",
    expected:
  ...
  },
  {
    ...
    expected:
      "Spring is ineligible (below half-time). Final Sub = Fall $1,750 only. Verification: $1,750 of $3,500 SOR limit used — remaining ineligible.",
    build: () =>
      mk(
        {
          viewMode: "disbursement",
  ...
  },
  {
    ...
    summary:
      "Sub $3,500 · Fall 6 paid at $875. Spring planned 12 but enrolls 18 — recalc gives Spring a balloon.",
    expected:
  ...
  // -------- FSA Examples (Apr 2026) --------
  {
    ...
    summary:
      "Sub $3,500 / Unsub $2,000 · Fall 6 / Spring 9 · 24 AY FT.",
    expected:
