      ...
      <section>
        ...
        <form onSubmit={submit} className="space-y-6 rounded-lg border border-border bg-card p-5 shadow-sm">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2"><Label>Award Year</Label><Select value={form.awardYear} onValueChange={(value) => set("awardYear", value)}><SelectTrigger><SelectValue /></SelectTrigger><SelectContent><SelectItem value="2026-27">2026-27</SelectItem><SelectItem value="2025-26">2025-26</SelectItem></SelectContent></Select></div>
            <div className="space-y-2"><Label>Program level</Label><Select value={form.programLevel} onValueChange={(value) => set("programLevel", value)}><SelectTrigger><SelectValue /></SelectTrigger><SelectContent><SelectItem value="undergraduate">Undergraduate</SelectItem><SelectItem value="graduate">Graduate</SelectItem></SelectContent></Select></div>
            <div className="space-y-2"><Label>Grade level</Label><Select value={form.gradeLevel} onValueChange={(value) => set("gradeLevel", value)}><SelectTrigger><SelectValue /></SelectTrigger><SelectContent><SelectItem value="g0">First year, no prior postsecondary</SelectItem><SelectItem value="g1">First year</SelectItem><SelectItem value="g2">Second year</SelectItem><SelectItem value="g3">Third year</SelectItem><SelectItem value="g4">Fourth year</SelectItem><SelectItem value="g8">Graduate</SelectItem><SelectItem value="g10">Professional</SelectItem></SelectContent></Select></div>
            <div className="space-y-2"><Label>Dependency status</Label><Select value={form.dependency} onValueChange={(value) => set("dependency", value)}><SelectTrigger><SelectValue /></SelectTrigger><SelectContent><SelectItem value="dependent">Dependent undergraduate</SelectItem><SelectItem value="independent">Independent</SelectItem></SelectContent></Select></div>
          </div>
          <div className="grid gap-4 sm:grid-cols-3"><div className="space-y-2"><Label htmlFor="fall">Fall credits</Label><Input id="fall" type="number" min="0" step="0.5" value={form.fallCredits} onChange={(e) => set("fallCredits", e.target.value)} /></div><div className="space-y-2"><Label htmlFor="spring">Spring credits</Label><Input id="spring" type="number" min="0" step="0.5" value={form.springCredits} onChange={(e) => set("springCredits", e.target.value)} /></div><div className="space-y-2"><Label htmlFor="ft">Full-time credits per term</Label><Input id="ft" type="number" min="0.5" step="0.5" value={form.fullTimeCreditsPerTerm} onChange={(e) => set("fullTimeCreditsPerTerm", e.target.value)} /><p className="text-xs text-muted-foreground">Use your school's published value.</p></div></div>
