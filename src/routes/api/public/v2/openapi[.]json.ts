...
const spec = {
  ...
  components: {
    schemas: {
      HealthResponse: {
        type: "object",
        required: ["status", "contractVersion", "engineVersion", "mcpVersion", "policyYear", "policySnapshotDate", "releaseId", "sourceCommit", "supportedAwardYears"],
        properties: {
          status: { type: "string", enum: ["ok"] }, contractVersion: { type: "string", example: "v2" }, engineVersion: { type: "string", example: ENGINE_VERSION }, mcpVersion: { type: "string", example: MCP_VERSION }, policyYear: { type: "string", example: POLICY_YEAR }, policySnapshotDate: { type: "string", example: POLICY_SNAPSHOT_DATE }, releaseId: { type: "string", example: RELEASE_ID }, sourceCommit: { type: "string" }, supportedAwardYears: { type: "object", additionalProperties: { type: "string" } },
        },
      },
      CalculateInput: {
        type: "object",
