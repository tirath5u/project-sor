...
const spec = {
  ...
  info: {
    ...
    description:
      "Source-backed Schedule of Reductions calculation API. V2 adds release metadata, V56 calculation stages, warnings, comparison, and student estimate routes.",
    license: { name: "MIT" },
  },
  ...
  paths: {
    ...
    "/api/public/v2/scenarios": {
      get: {
        summary: "Canonical scenario fixtures",
        responses: {
          "200": {
    ...
    "/api/public/v2/calculate": {
      post: {
        ...
        requestBody: {
          required: true,
          content: {
            "application/json": { schema: { $ref: "#/components/schemas/CalculateInput" } },
          },
        },
        responses: {
          "200": {
    ...
    "/api/public/v2/student-estimate": {
      post: {
        ...
        description:
          "A narrow estimate for a standard two-term path. It is not an award, approval, or final school determination.",
        requestBody: {
          required: true,
          content: {
            "application/json": { schema: { $ref: "#/components/schemas/StudentEstimateInput" } },
          },
        },
        responses: {
          "200": {
          ...
          "422": { description: "Invalid estimate inputs" },
        },
      },
    },
    "/api/public/v2/compare": {
      post: {
        ...
        description:
          "Runs both scenarios independently through the shared engine. The service is stateless and returns numeric deltas, warning changes, and authoritative status for each side.",
        requestBody: {
          required: true,
          content: {
        ...
        responses: {
          "200": {
            ...
            content: {
              "application/json": { schema: { $ref: "#/components/schemas/CompareResponse" } },
            },
          },
          "422": { description: "Invalid comparison inputs" },
        },
      },
    },
    "/api/public/v2/student-advanced": {
      post: {
        ...
        description:
          "Runs a complete institution-specific V2 input through the shared engine and returns a student-readable projection with stages, warnings, and external checks. It is not an award and is stateless.",
        requestBody: {
          required: true,
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/AdvancedStudentEstimateRequest" },
            },
          },
        },
        responses: {
          "200": {
            description: "Advanced estimate",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/AdvancedStudentEstimateResponse" },
              },
            },
          },
          "422": { description: "Invalid advanced estimate inputs" },
        },
      },
    },
    "/api/public/v2/migration-compare": {
      post: {
        ...
        description:
          "Runs the current V56 engine against a stored, approved V55 baseline. This is a stateless migration aid and does not accept arbitrary historical inputs.",
        requestBody: {
          required: true,
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/MigrationCompareRequest" },
            },
          },
        },
        responses: {
          "200": {
            description: "Migration comparison",
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/MigrationCompareResponse" },
              },
            },
          },
          "422": { description: "Fixture is not approved for migration comparison" },
        },
      },
    },
  },
    ...
    schemas: {
      HealthResponse: {
        ...
        properties: {
          ...
          contractVersion: { type: "string", example: "v2" },
      ...
      CalculateInput: {
        ...
        properties: {
          ...
          requestedSub: { type: ["number", "null"], minimum: 0 },
          requestedUnsub: { type: ["number", "null"], minimum: 0 },
          preSorCaps: {
            type: "object",
            additionalProperties: false,
            properties: {
          ...
          remainingAnnualSub: { type: ["number", "null"], minimum: 0 },
          remainingAnnualUnsub: { type: ["number", "null"], minimum: 0 },
          remainingAnnualCombined: { type: ["number", "null"], minimum: 0 },
          remainingAggregateSub: { type: ["number", "null"], minimum: 0 },
          remainingAggregateUnsub: { type: ["number", "null"], minimum: 0 },
          remainingAggregateCombined: { type: ["number", "null"], minimum: 0 },
        ...
        properties: {
          ...
          contract: {
            ...
            properties: {
              calculationStatus: {
                type: "string",
                enum: ["calculated", "calculated_with_external_checks", "blocked"],
              },
              authoritative: { type: "boolean" },
              policyDecision: { type: "object", additionalProperties: true },
              eligibilityStages: {
                type: "array",
                items: { type: "object", additionalProperties: true },
              },
              modeledInputs: { type: "array", items: { type: "string" } },
              ...
              inputPresence: { type: "object", additionalProperties: { type: "boolean" } },
            },
          },
        },
      },
      StudentEstimateInput: {
        ...
        properties: {
          ...
          gradeLevel: { type: "string" },
          dependency: { type: "string", enum: ["dependent", "independent"] },
          fallCredits: { type: "number", minimum: 0 },
          springCredits: { type: "number", minimum: 0 },
          fullTimeCreditsPerTerm: { type: "number", exclusiveMinimum: 0 },
        },
      },
      CompareRequest: {
        type: "object",
        ...
        required: ["left", "right"],
        properties: {
          left: { $ref: "#/components/schemas/CalculateInput" },
          right: { $ref: "#/components/schemas/CalculateInput" },
        },
      },
      CompareResponse: {
        type: "object",
        ...
        properties: {
          status: { type: "string", enum: ["compared"] },
      ...
      AdvancedStudentEstimateRequest: {
        ...
        properties: {
          ...
          resultDetail: { type: "string", enum: ["summary", "detailed"], default: "detailed" },
        },
      },
      AdvancedStudentEstimateResponse: {
        ...
        properties: {
          ...
          audience: { type: "string", enum: ["student-advanced"] },
      ...
      MigrationCompareResponse: {
        ...
        properties: {
          status: { type: "string", enum: ["compared"] },
          audience: { type: "string", enum: ["staff"] },
          comparison: { type: "object", additionalProperties: true },
          meta: { type: "object", additionalProperties: true },
        },
      },
