...
const AdvancedStudentSchema = z.object({
        ...
        try {
          ...
          return jsonResponse({
            ...
            estimate: {
              ...
              estimatedAnnualTotal: result.reducedSub + result.reducedUnsub + result.reducedGradPlus,
              grossBasis: true,
            },
            ...
            disclaimer: "This advanced estimate is decision support, not an award, approval, or guarantee. The school must verify COA, OFA, need, aggregate eligibility, institutional definitions, timing, SAP, proration, R2T4, COD, NSLDS, and all other requirements.",
            unsupported: ["final award", "COD origination", "NSLDS records", "institutional approval"],
            meta: {
          ...
          return errorResponse("internal_error", "Advanced estimate engine failed.", error instanceof Error ? { name: error.name } : undefined, undefined, requestId);
        }
      },
    },
  },
