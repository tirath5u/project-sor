  ...
  server: {
    handlers: {
      ...
      GET: async ({ request }) => {
        ...
        return jsonResponse({ contractVersion: "v2", engineVersion: ENGINE_VERSION, policyYear: POLICY_YEAR, releaseId: RELEASE_ID, count: scenarios.length, scenarios, requestId }, { headers: { "X-Request-Id": requestId } });
      },
